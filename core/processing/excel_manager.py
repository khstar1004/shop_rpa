    ...
    def insert_image_to_excel(self, image_path: str, target_cell: str):
        ...
        try:
            ...
            try:
                ...
                self.logger.error(
                    "Required libraries missing. Install win32com.client and pillow."
                )
                return False
            ...
            try:
                with PILImage.open(abs_image_path) as img:
                    ...
                    resized_path = (
                        os.path.splitext(abs_image_path)[0]
                        + "_resized"
                        + os.path.splitext(abs_image_path)[1]
                    )
            ...
            self.logger.error(
                f"Error in insert_image_to_excel: {str(e)}", exc_info=True
            )
            return False
