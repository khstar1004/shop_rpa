...
class Product:
    ...
    options: Optional[List[Dict[str, Any]]] = None  # List of available options (e.g., colors, sizes)
...
class ProcessingResult:
    ...
    def to_dict(self) -> Dict:
        return {
            ...
            'best_koryo_match': self.best_koryo_match.to_dict() if self.best_koryo_match else None,
            'best_naver_match': self.best_naver_match.to_dict() if self.best_naver_match else None,
            'error': self.error,
        } 